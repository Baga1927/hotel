(() => {
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker1]")) {
            const picker = datepicker_min("[data-datepicker1]", {
                customDays: [ "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun" ],
                customMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec" ],
                overlayButton: "Input",
                overlayPlaceholder: "Year ",
        ...
        function initSliders() {
            if (document.querySelector(".team__slider", ".blog__slider")) new core(".team__slider", {
